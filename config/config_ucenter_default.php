...
// ============================================================================
define('UC_CONNECT', 'mysqli');				// 连接 UCenter 的方式: mysqli/NULL, 默认为空时为 fscoketopen(), mysqli 是直接连接的数据库, 为了效率, 建议采用 mysqli
// 数据库相关 (mysqli 连接时)
...
define('UC_IP', '127.0.0.1');				// UCenter 的 IP, 当 UC_CONNECT 为非 mysqli 方式时, 并且当前应用服务器解析域名有问题时, 请设置此值
